...
import informacionJson from './data.json'
import Post from './Post'
export default function Posteos(acumulador) {
  return (
    <div className='container'>
      {informacionJson.map(element => <Post key={element.id} element={element}acumulador ={acumulador}/>)}
    </div>
  )
}
